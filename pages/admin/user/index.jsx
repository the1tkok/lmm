        ...
        <Link href="/admin/user/list">
          <div className={styles.studentsOverviewContainer}>
            ...
            <div className={styles.userTypeCard}>
              <p className={styles.studentStatsOverviewTitle}>All Users</p>
            </div>
          </div>
        </Link>
        {/*****USER STATS OVERVIEW CONTAINER*****/}
        <Link href="/admin/user/list?subscription=freemium">
          <div className={styles.userTypeContainer}>
            {/*****USER STATS*****/}
            <div className={styles.userTypeCard}>
              <p className={styles.studentStatsOverviewTitle}>Freemium</p>
            </div>
          </div>
        </Link>
        {/*****USER STATS OVERVIEW CONTAINER*****/}
        <Link href="/admin/user/list?subscription=foundation">
          <div className={styles.courseOverviewContainer}>
            {/*****USER STATS*****/}
            <div className={styles.userTypeCard}>
              <p className={styles.studentStatsOverviewTitle}>Foundations</p>
            </div>
          </div>
        </Link>
        {/*****STUDENTS OVERVIEW CONTAINER*****/}
        <Link href="/admin/user/list?subscription=academy">
          <div className={styles.studentsOverviewContainer}>
            {/*****USER STATS*****/}
            <div className={styles.userTypeCard}>
              <p className={styles.studentStatsOverviewTitle}>Academy</p>
            </div>
          </div>
        </Link>
      </div>
