    ...
    <div className={styles.dashboardContainer}>
      ...
      <div className={styles.dashboardMainContainer}>
        ...
        <iframe
          ...
          src={"https://player.vimeo.com/video/479896077?h=05f7e915e1"}
        ></iframe>
          ...
          <ul>
            <li>
              <p className={styles.additionalResourcesText}>
                <Link href="/">
                  Read this to learn what casting directors look for.
                </Link>
              </p>
            </li>
            <li>
              <p className={styles.additionalResourcesText}>
                <Link href="/">Check out these casting wardrobe tips.</Link>
              </p>
            </li>
            <li>
              <p className={styles.additionalResourcesText}>
                <Link href="/">
                  Learn what method acting is and when to use it.
                </Link>
              </p>
            </li>
          </ul>
