...
export default function Dashboard() {
  return (
    <div className={styles.dashboardContainer}>
      ...
      <Header item1="One on One Coaching" item2="About" item3="Blog" item4="Log Out" item5="Upgrade Plan" navContainer="navContainerDashboard" navUl="navUlDashboard" logoStyling="logo2Dashboard"></Header>
