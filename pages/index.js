...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <Header item1="View Curriculum" item2="Pricing" item3="Blog" item4="Login" item5="Register" link4="./login/Login" link5="./register/Register" navContainer="navContainer" navUl="navUl" logoStyling="logo2"></Header>
      {/*****HERO SECTION*****/}
