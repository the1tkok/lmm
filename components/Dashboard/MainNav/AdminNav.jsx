  ...
  return (
    <div className={styles.userDashboardNavBar}>
      ...
      <Link href={{pathname: '/admin'}} passHref legacyBehavior>
        <li className={currentRoute === '/admin' ? styles.dashboardHomeButton : styles.dashboardHomeButtonActive}>
          <Image
            className={currentRoute === '/admin' ? styles.dashboardSchoolIcon : styles.dashboardSchoolIconActive}
            src={currentRoute === '/admin' ? SchoolIcon : SchoolDarkIcon}
            alt="background image"
          ></Image>
            <a className={currentRoute === '/admin' ? styles.dashboardHomeText : styles.dashboardHomeTextActive}>User Overview</a>
        </li>
      </Link>
