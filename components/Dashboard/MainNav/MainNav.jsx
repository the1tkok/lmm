  ...
  return (
    <div className={styles.userDashboardNavBar}>
      ...
      <ul className={styles.dashboardNavItems}>
        <li className={styles.dashboardHomeButton}>
          <Image
            className={styles.dashboardSchoolIcon}
            src={SchoolIcon}
            alt="background image"
          ></Image>
          <Link href={"/"}>
            <a className={styles.dashboardHomeText}>Home</a>
          </Link>
        </li>
        <li className={styles.dashboardClassesButton}>
          ...
          ></Image>
          <Link href={"/"}>
            <a className={styles.dashboardHomeText}>Classes</a>
          </Link>
        </li>
        <li className={styles.dashboardCourseMaterialsButton}>
          ...
          ></Image>
          <Link href={"/"}>
            <a className={styles.dashboardHomeText}>Course Materials</a>
          </Link>
        </li>
        <li className={styles.dashboardCommunityButton}>
          ...
          ></Image>
          <Link href={"/"}>
            <a className={styles.dashboardHomeText}>Community</a>
          </Link>
        </li>
        <li className={styles.dashboardMessagesButton}>
          ...
          ></Image>
          <Link href={"/"}>
            <a className={styles.dashboardHomeText}>Messages</a>
          </Link>
        </li>
      </ul>
    </div>
